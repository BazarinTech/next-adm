                                    ...
                                    <div class="p-5 space-y-4">
                                        <div class="text-black dark:text-muted">
                                            ...
                                            <div class="space-y-1 my-4">
                                                <label>Role</label>
                                                <input type="text" class="form-input h-14" placeholder="Role" required>
                                            </div>
                                            <div class="space-y-1 my-4">
                                                <label>Permissions</label>
                                                <input type="text" class="form-input h-14" placeholder="eg [edit][add]" required>
                                            </div>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <h2 class="mb-4 text-base font-semibold capitalize text-slate-800 dark:text-slate-100">Products Records</h2>
                            ...
                            <div class="overflow-auto" x-data="{ items: [
                                { id: 1, image: 'hdbjbjd', name: 'Bazarin', role: 'CEO', permissions: '[edit][add]', status: 'Active', time: '2025-13-3 12:00:00' },
                              ]
                            }">
                                        ...
                                        <template x-for="item in items" :key="item.id">
                                            <tr x-show="showElement" x-data="{ showElement: true }">
                                                ...
                                                <td>
                                                    ...
                                                    " x-show="!item.editing"></span>
                                                    <input type="text" class="form-input" x-ref="role" x-model="item.role" x-on:keydown.enter="item.editing = false" x-show="item.editing">
                                                </td>
                                                <td>
                                                    ...
                                                    " x-show="!item.editing"></span>
                                                    <input type="text" class="form-input" x-ref="permissions" x-model="item.permissions" x-on:keydown.enter="item.editing = false" x-show="item.editing">
                                                </td>
                                                <td>
