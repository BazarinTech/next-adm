                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <h2 class="mb-4 text-base font-semibold capitalize text-slate-800 dark:text-slate-100">Rolls Records</h2>
                            ...
                            <div class="overflow-auto" x-data="{ items: [
                                { id: 1, image: 'hdbjbjd', name: 'Shoes Huhu(hu)', price: '500,000.00', rolls: '1', status: 'Active', time: '2025-13-3 12:00:00' },
                              ]
                            }">
                                        ...
                                        <template x-for="item in items" :key="item.id">
                                            <tr x-show="showElement" x-data="{ showElement: true }">
                                                ...
                                                <td>
                                                    ...
                                                    " x-show="!item.editing"></span>
                                                    <input type="text" class="form-input" x-ref="rolls" x-model="item.rolls" x-on:keydown.enter="item.editing = false" x-show="item.editing">
                                                </td>
                                                <td>
