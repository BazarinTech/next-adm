                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <h2 class="mb-4 text-base font-semibold capitalize text-slate-800 dark:text-slate-100">Transaction Records</h2>
                            <div class="overflow-auto" x-data="{ items: [
                                { id: 1, email: 'l@gmail.com', amount: '300,000.00', type: 'withdraw', status: 'Success', description: 'TDR4FRDRF', fee: '15.00', time: '2025-13-3 8:20 pm' },
                              ]
                            }">
                                        ...
                                        <template x-for="item in items" :key="item.id">
                                            <tr x-show="showElement" x-data="{ showElement: true }">
                                                ...
                                                <td>
                                                    ...
                                                    " x-show="!item.editing"></span>
                                                    <input type="text" class="form-input" x-ref="amount" x-model="item.amount" x-on:keydown.enter="item.editing = false" x-show="item.editing">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    " x-show="!item.editing"></span>
                                                    <input type="text" class="form-input" x-ref="description" x-model="item.description" x-on:keydown.enter="item.editing = false" x-show="item.editing">
                                                </td>
                                                <td>
                                                    ...
                                                    " x-show="!item.editing"></span>
                                                    <input type="text" class="form-input" x-ref="fee" x-model="item.fee" x-on:keydown.enter="item.editing = false" x-show="item.editing">
                                                </td>
                                                <td>
